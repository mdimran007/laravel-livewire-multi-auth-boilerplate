<div>
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('admin.research.create') }}" class="btn bg-success text-white">
            + {{ __('Add New') }}
        </a>
    </div>
    ...
    <div class="mt-6">
                                        ...
                                        <div class="grid grid-cols-5">
                                            ...
                                            <div class="col-span-3 p-3">
                                                ...
                                                <div class="flex mt-3 gap-2">
                                                    ...
                                                    <a href="{{ route('admin.research.edit', $data->id) }}"
                                                        title="{{ __('Edit') }}"
                                                        class="bg-primary border-2 flex-1 hover:bg-gray-400 px-4 py-2 rounded-lg text-gray-500 text-white">
        ...
        <div class="flex justify-between items-center mt-4">
            <div>
                Showing {{ $researchList->firstItem() }} to {{ $researchList->lastItem() }} of
                {{ $researchList->total() }} results
            </div>
            ...
            <div class="flex space-x-1">
                ...
                @foreach ($researchList->getUrlRange(1, $researchList->lastPage()) as $page => $url)
                    <button wire:click="gotoPage({{ $page }})"
                        class="px-3 py-1 rounded {{ $page == $researchList->currentPage() ? 'bg-slate-700 px-3 py-1 rounded text-white' : 'bg-gray-200 text-gray-700' }}">
                        {{ $page }}
                    </button>
                @endforeach
