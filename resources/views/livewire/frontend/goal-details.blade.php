<div>
    ...
    <div class="relative bg-cover bg-center"
        style="background-image: url('{{ $goal->images ? asset('storage/' . $goal->images) : asset('assets/no-image.png') }}')">
    ...
    <nav class="sticky top-16 z-40 bg-gray-900/80 backdrop-blur-sm py-4 border-b border-white/10">
        <div class="h-full lg:px-8 mx-auto px-4 sm:px-6 w-4/5">

            <div class="flex items-center overflow-x-auto pt-[18px] scrollbar-hidden space-x-4">
            ...
            @foreach ($data as $key => $items)
                @if ($items->count() > 0)
                    <section id="{{ $key }}" class="mb-16 scroll-mt-20">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 gap-6">
                                ...
                                <article
                                    ...
                                    <div class="flex h-full">
                                        ...
                                        <div
                                            ...
                                            <div>
                                                <h3 class="text-lg font-semibold text-white">
                                                    ...
                                                    <span
                                                        ...
                                                        {{ $item->title ? Str::limit($item->title, 10, '...') : 'N/A' }}
                                                    </span>
                                                ...
                                                <p class="mt-2 text-sm text-gray-200 line-clamp-3">
                                                    ...
                                                    <span
                                                        class="block sm:hidden md:hidden lg:hidden xl:hidden 2xl:hidden">
                                                        {{ $item->short_description ? Str::limit($item->short_description, 25, '...') : 'N/A' }}
                                                    </span>
                                                    ...
                                                    <span
                                                        class="hidden sm:hidden md:block lg:hidden xl:hidden 2xl:hidden">
                                                        {{ $item->short_description ? Str::limit($item->short_description, 30, '...') : 'N/A' }}
                                                    </span>
                                            ...
                                            <div class="custom-md:hidden mt-4 flex items-center justify-between">
