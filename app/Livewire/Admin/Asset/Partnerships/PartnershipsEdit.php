...
class PartnershipsEdit extends Component
{
    use WithFileUploads;

    public $pageTitle = "Partnerships Edit";
    ...
    public function mount($id = null)
    {
        ...
        if ($id) {
            $this->dataId = $id;
            $research = Partnership::with('goals')->findOrFail($id);
    ...
    public function render()
    {
        ...
        return view('livewire.admin.asset.partnerships.partnerships-edit');
    }
      ...
      public function store()
    {
        $this->validate(
            ...
            [
                'title.required' => 'The partnership title is required.',
        ...
        if ($this->image) {
            $path = $this->image->store('partnership', 'public');
            $data['images'] = $path;
        }

        $data = Partnership::updateOrCreate(['id' => $this->dataId], $data);
