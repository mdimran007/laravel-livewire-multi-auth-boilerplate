...
namespace App\Livewire\Admin\Asset\Facilities;
...
class FacilitiesCreate extends Component
{
     use WithFileUploads;

    public $pageTitle = "New Facilities";
    ...
    {
        return view('livewire.admin.asset.facilities.facilities-create');
    }
    ...
    public function store()
    {
        $this->validate(
            ...
            [
                'title.required' => 'The facilities title is required.',
        ...
        $data = Facility::updateOrCreate(['id' => $this->dataId], $data);
