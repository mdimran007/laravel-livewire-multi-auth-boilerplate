...
class Facilities extends Component
{
    ...
    public $pageTitle = "Facility List";
    public $dataId;
    public $goals = [];
    public $title;
    ...
    {
        $data = Facility::with(['goals', 'creator'])->findOrFail($id);
        $this->dataId = $data->id;
    ...
    {
        $dataList = Facility::with('goals')
            ->orderBy('created_at', 'desc')
            ->paginate(16);

        return view('livewire.admin.asset.facilities.facilities', [
            'dataList' => $dataList
        ]);
    }
