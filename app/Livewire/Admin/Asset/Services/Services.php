...
class Services extends Component
{
    ...
    {
        $data = Service::with(['goals', 'creator'])->findOrFail($id);
        $this->dataId = $data->id;
    ...
    {
        $dataList = Service::with('goals')
            ->orderBy('created_at', 'desc')
            ->paginate(16);

        return view('livewire.admin.asset.services.services', [
            'dataList' => $dataList
        ]);
    }
