...
namespace App\Livewire\Admin\Asset\Report;
...
class ReportEdit extends Component
{
    ...
    public function mount($id = null)
    {
        ...
        if ($id) {
            $this->dataId = $id;
            $research = Report::with('goals')->findOrFail($id);
    ...
    public function render()
    {
        ...
        return view('livewire.admin.asset.report.report-edit');
    }
      ...
      public function store()
    {
        ...
        if ($this->image) {
            $path = $this->image->store('report', 'public');
            $data['images'] = $path;
        }

        $data = Research::updateOrCreate(['id' => $this->dataId], $data);
