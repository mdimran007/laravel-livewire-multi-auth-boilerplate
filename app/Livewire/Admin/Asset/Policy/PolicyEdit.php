...
class PolicyEdit extends Component
{
    ...
    public function mount($id = null)
    {
        ...
        if ($id) {
            $this->dataId = $id;
            $research = Policy::with('goals')->findOrFail($id);
    ...
    public function render()
    {
        ...
        return view('livewire.admin.asset.policy.policy-edit');
    }
      ...
      public function store()
    {
        ...
        if ($this->image) {
            $path = $this->image->store('policy', 'public');
            $data['images'] = $path;
        }

        $data = Policy::updateOrCreate(['id' => $this->dataId], $data);
