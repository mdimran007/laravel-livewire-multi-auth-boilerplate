...
class CommitteeEdit extends Component
{
    use WithFileUploads;

    public $pageTitle = "Update Member";
    ...
    public function mount($id = null)
    {
        ...
        if ($id) {
            $this->dataId = $id;
            $data = CommitteeMember::with('goals')->findOrFail($id);
            $this->name = $data->name;
            $this->designation = $data->designation;
            $this->url = $data->url;
            $this->status = $data->status;
            $this->existingPicture = $data->picture;
            $this->selectedGoals = $data->goals->pluck('id')->toArray();
        }
    }
    ...
    {
        return view('livewire.admin.committee.committee-edit');
    }
}
